...
#ifdef THERMO
void LocalMesh_yyu(Element_List *EL, Element_List *EL_T, char *name, Element_List *U, Element_List *T);
#endif
...
void   Find_local_coords   (Element_List *U, Coord *X, int Npts, 
			    int **Eids, Coord **A);
//void   Find_local_coords   (Element_List *U, Coord *X, int Npts,
//                            int **Eids, Coord **A, bool SetUpMem = true);
