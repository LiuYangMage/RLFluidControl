...
class Fourier_List: public Element_List {
 public:
  ...
  void Grad_z_h(int nz, int ntot, double *HL, double *EL);

  void Trans(int ntot, double *HL, double *EL, Nek_Trans_Type ntt); // FFT from HL--> EL
  void FFT(int ntot, double *HL, double *EL, Nek_Trans_Type ntt);
  void FFT32(int ntot, double *HL, double *EL, Nek_Trans_Type ntt);
};
