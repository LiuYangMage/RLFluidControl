...
#if 0 
	  static int FLAG_INDEX_IVERT=0;

          FILE *sparse_ivert;
          char sparse_ivert_name[128];
          sprintf(sparse_ivert_name,"sparse_ivert_%d_%d.dat",FLAG_INDEX_IVERT,mynode());
...
void Tet::LowEnergyModes(Bsystem *B, int *Ne, int *Nf, double ***Rv, 
  ...
  //LG : modification
  static option_variable = -1;

  if (option_variable = -1)
    option_variable = option("variable");
